                  ...
                  <div className="mt-7 flex space-x-3 w-full">
                    ...
                    <div className="flex-grow mt-2">
                      ...
                      <div className="flex items-center justify-between pt-2.5">
                        ...
                        <button
                          className="bg-[#f01d4e] text-white rounded-full px-4 py-1.5 font-bold shadow-md hover:bg-[#d81a46] disabled:hover:bg-[#f01d4e] disabled:opacity-50 disabled:cursor-default"
                          type="submit"
                          onClick={sendComment}
